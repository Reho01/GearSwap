...
function user_unload()
	...
	-- Saying hello
	windower.add_to_chat(8,'----- Welcome back to your WHM v1.17 Gearswap, '..pName..' -----')
...
function init_gear_sets()
    ...
    sets.midcast.CureSolace = {
        ...
        body="Ebers Bliaud +1",
        hands="Kaykaus cuffs", --(+10)/(-10)
        legs="Ebers Pantaloons +1",
        feet="Kaykaus Boots", --11(+2)/(-10)
        neck="Nuna gorget",
        ear1="Glorious Earring", --7
        ear2="Medicant's Earring", -- (+2)/(-5)
