...
-- Saying hello
windower.add_to_chat(8,'----- Welcome back to your BLU v1.17 Gearswap, '..pName..' -----')
...
function user_setup()
    state.OffenseMode:options('Normal', 'PDT', 'Learning')
...
function init_gear_sets()
    ...
    sets.precast.WS = {
        head="Adhemar bonnet +1",neck="Fotia gorget",ear1="Bladeborn earring",ear2="Ishvara Earring",
        body="Adhemar jacket +1",hands="Jhakri Cuffs +2",ring1="Ifrit Ring",ring2="Apate Ring",
		waist="Fotia belt",back=gear.BLU_WS2_Cape,legs="Adhemar Kecks +1",feet="Carmine greaves +1"}
    ...
    sets.precast.WS['Sanguine Blade'] = {
        ...
        body="Amalric Doublet +1",hands="Amalric Gages +1",ring1="Jhakri Ring",ring2="Strendu Ring",
        back="Cornflower Cape", waist="Eschan Stone", legs="Amalric Slops +1",feet="Amalric Nails +1"}
		
    sets.precast.WS['Savage Blade'] = {
        head={ name="Herculean Helm", augments={'Weapon skill damage +5%','DEX+7','Accuracy+8','Attack+11',}},neck="Fotia gorget",ear1="Moonshade Earring",ear2="Ishvara Earring",
        body="Adhemar jacket +1",hands="Jhakri Cuffs +2",ring1="Ifrit Ring",ring2="Epaminondas's Ring",
		waist="Fotia belt",back={ name="Rosmerta's Cape", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}},
	...
	sets.precast.WS['Chant du Cygne'] = {
        head="Adhemar bonnet +1",neck="Fotia gorget",ear1="Thunder Pearl",ear2="Ishvara Earring",
        body="Adhemar jacket +1",hands="Jhakri Cuffs +2",ring1="Thundersoul Ring",ring2="Apate Ring",
		waist="Fotia belt",back={ name="Rosmerta's Cape", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}},
		legs={ name="Herculean Trousers", augments={'Weapon skill damage +4%','STR+15','Attack+12',}},
    ...
    sets.midcast.FastRecast = {
        ...
        hands="Mavi Bazubands +2",ring1="Weather. Ringg",
        back="Swith Cape",legs="Aya. Cosciales +1",feet="Carmine Greaves +1"}
    ...
    sets.midcast['Blue Magic'].Physical = {ammo="Ginsen",
        head="Adhemar bonnet +1",neck="Clotharius Torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Adhemar jacket +1",hands="Adhemar Wristbands +1",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Rosmerta's cape",waist="Goading Belt",legs="Taeon Tights",feet="Adhemar Gamashes +1"}
    ...
    sets.midcast['Blue Magic'].Magical = {ammo="Dosis Tathlum",
       ...
       body="Cohort cloak +1",hands="Amalric Gages +1",ring1="Jhakri Ring",ring2="Strendu Ring",
       back="Cornflower Cape", waist="Eschan Stone", legs="Amalric Slops +1",feet="Amalric Nails +1"}
    ...
    sets.midcast['Blue Magic'].Healing = {
        ...
        body="Jhakri Robe +2",hands="Telchine Gloves",neck="Phalaina Locket",ring1="Aquasoul Ring",ring2="Sirona's Ring",
        back="Pahtli Cape",legs="Carmine Cuisses +1",feet="Carmine Greaves +1"}
    ...
    sets.idle = {ammo="Impatiens",
        ...
        body="Jhakri robe +2",hands="Malignance Gloves",ring1="Defending Ring",ring2="Chirich Ring +1",
        back="Moonlight Cape",waist="Flume Belt +1",legs="Rawhide Trousers",feet="Serpentes Sabots"}
		
	sets.idle.PDT = {ammo="Staunch tathlum",
        head="Malignance Chapeau",neck="Loricate torque +1",ear1="Odnowa Earring",ear2="Odnowa Earring +1",
        body="Ayanmo corazza +2",hands="Malignance Gloves",ring1="Defending Ring",ring2="Dark ring",
    ...
    sets.defense.MDT = {ammo="Staunch tathlum",
        head="Malignance Chapeau",neck="Ayanmo zucchetto +1",ear1="Odnowa Earring +1",ear2="Odnowa Earring",
        body="Ayanmo corazza +2",hands="Malignance Gloves",ring1="Defending Ring",ring2="Ayanmo Ring",
        back="Moonlight Cape",legs="Ayanmo cosciales +1",feet="Ayanmo gambieras +1"}
    ...
    sets.engaged = {ammo="Ginsen",
        head="Adhemar bonnet +1",neck="Clotharius Torque",ear1="Brutal Earring",ear2="Telos earring",
        body="Adhemar jacket +1",hands="Adhemar Wristbands +1",
		left_ring="Epona's Ring",ring2="Petrov Ring",
        back={name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Store TP"+10',}},waist="Windbuffet Belt +1",legs="Samnuha Tights",feet={ name="Herculean Boots", augments={'Accuracy+15 Attack+15','"Triple Atk."+3','DEX+3','Accuracy+5','Attack+9',}}}
