...
-- Saying hello
windower.add_to_chat(8,'----- Welcome back to your SMN v1.00 Gearswap, '..pName..' -----')
...
function init_gear_sets()
    ...
    sets.precast.JA['Elemental Siphon'] = {    main={ name="Grioavolr", augments={'"Fast Cast"+6','Mag. Acc.+15','"Mag.Atk.Bns."+9','Magic Damage +4',}},
    sub="Clerisy Strap",
    ammo="Impatiens",
    ...
    sets.precast.BloodPactWard = {ammo="Seraphicaller",head="Convoker's Horn",body="Glyphic Doublet",hands="Glyphic Bracers", ear1="Caller's Earring",
        back="Samanisi Cape"}
    ...
    sets.midcast.Cure =  {    main="Tefnut Wand",
    sub="Sors Shield",
    ammo="Impatiens",
    head={ name="Vanya Hood", augments={'MP+50','"Fast Cast"+10','Haste+2%',}},
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = {main={ name="Espiritus", augments={'Enmity-6','Pet: "Mag.Atk.Bns."+30','Pet: Damage taken -4%',}},ammo="Sancus Sachet +1",
        head={ name="Apogee Crown +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}},neck="Caller's Pendant",
        body="Con. Doublet +1",hands={ name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+25 Pet: "Mag.Atk.Bns."+25','Pet: Crit.hit rate +1','Pet: INT+8','Pet: "Mag.Atk.Bns."+13',}},ring1="Evoker's Ring",ring2="Varar Ring +1",ear1="Kyrene's Earring",ear2="Gelos Earring",
        waist="Diabolos's Rope",legs={ name="Apogee Slacks +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}},feet={ name="Apogee Pumps +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}}}

    sets.midcast.Pet.PhysicalBloodPactRage.Acc = sets.midcast.Pet.PhysicalBloodPactRage

    sets.midcast.Pet.MagicalBloodPactRage = {main={ name="Espiritus", augments={'Enmity-6','Pet: "Mag.Atk.Bns."+30','Pet: Damage taken -4%',}},ammo="Sancus Sachet +1",
        head={ name="Apogee Crown +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}},neck="Caller's Pendant",
        body="Con. Doublet +1",hands={ name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+25 Pet: "Mag.Atk.Bns."+25','Pet: Crit.hit rate +1','Pet: INT+8','Pet: "Mag.Atk.Bns."+13',}},ring1="Evoker's Ring",ring2="Varar Ring +1",ear1="Kyrene's Earring",ear2="Gelos Earring",
        waist="Diabolos's Rope",legs={ name="Apogee Slacks +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}},feet={ name="Apogee Pumps +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}}}
    ...
    sets.idle.Avatar = {main="Gridarvor",sub="Elan Strap +1",ammo="Sancus Sachet +1",
        head="Apogee Crown +1",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Shomonjijoe +1",hands="Asteria Mitts",ring1="Evoker's Ring",ring2="Sangoma Ring",
        back={ name="Campestres's Cape", augments={'Pet: Acc.+10 Pet: R.Acc.+10 Pet: Atk.+10 Pet: R.Atk.+10',}},waist="Fucho-no-Obi",legs="Assiduity Pants",feet="Apogee Pumps +1"}
